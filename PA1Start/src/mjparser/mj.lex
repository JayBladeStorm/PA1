...
(/\*([^*]|[\r\n]|(\*+([^*/]|[\r\n])))*\*+/)|(//.*) { }
(0|([1-9][0-9]*)) {return new Symbol(sym.INT_LITERAL,new SymbolValue(yyline+1, yychar+1, yytext(), Integer.parseInt(yytext())));}
(_|[a-zA-Z])(_|[a-zA-Z]|[0-9])* {return new Symbol(sym.ID,new SymbolValue(yyline+1, yychar+1, yytext()));}
